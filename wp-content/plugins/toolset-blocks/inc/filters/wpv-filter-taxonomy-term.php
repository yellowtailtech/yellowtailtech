...
//Needed to have wp_terms_checklist() function
...
class WPV_Taxonomy_Term_Filter {
    ...
    static function on_load() {
		...
		add_action( 'rest_api_init', array( 'WPV_Taxonomy_Term_Filter', 'admin_init' ) );
    }

    static function init() {
		wp_register_script(
			'views-filter-taxonomy-term-js',
			WPV_URL . "/res/js/filters/views_filter_taxonomy_term.js",
