...
/**
 * Source for offering the author's last name as dynamic content.
 *
 * @package toolset-dynamic-sources
 */
class AuthorLastName extends AuthorSource {
	const NAME = 'author-last-name';
	...
	public function get_content( $field = null, $attributes = null ) {
		return wp_kses_post( get_the_author_meta( 'last_name' ) );
	}
}
