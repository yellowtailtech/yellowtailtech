...
use WPFormsConvertKit\Vendor\GuzzleHttp\Cookie\CookieJar;
use WPFormsConvertKit\Vendor\GuzzleHttp\Exception\GuzzleException;
use WPFormsConvertKit\Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \WPFormsConvertKit\Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
