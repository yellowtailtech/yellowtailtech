...
namespace WPFormsConvertKit\Vendor\GuzzleHttp\Exception;

use WPFormsConvertKit\Vendor\GuzzleHttp\BodySummarizer;
use WPFormsConvertKit\Vendor\GuzzleHttp\BodySummarizerInterface;
use WPFormsConvertKit\Vendor\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null) : self
    {
        ...
        $uri = \WPFormsConvertKit\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
