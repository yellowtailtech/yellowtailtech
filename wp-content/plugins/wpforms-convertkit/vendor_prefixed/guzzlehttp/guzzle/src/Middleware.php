...
use WPFormsConvertKit\Vendor\GuzzleHttp\Cookie\CookieJarInterface;
...
use WPFormsConvertKit\Vendor\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('WPFormsConvertKit\\Vendor\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
