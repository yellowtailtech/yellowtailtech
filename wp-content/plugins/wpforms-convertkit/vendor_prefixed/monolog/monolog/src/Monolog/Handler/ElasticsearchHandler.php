...
use WPFormsConvertKit\Vendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use WPFormsConvertKit\Vendor\Monolog\Logger;
use WPFormsConvertKit\Vendor\Monolog\Formatter\FormatterInterface;
use WPFormsConvertKit\Vendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use WPFormsConvertKit\Vendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use WPFormsConvertKit\Vendor\Elasticsearch\Client;
use WPFormsConvertKit\Vendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use WPFormsConvertKit\Vendor\Elastic\Elasticsearch\Client as Client8;
/**
