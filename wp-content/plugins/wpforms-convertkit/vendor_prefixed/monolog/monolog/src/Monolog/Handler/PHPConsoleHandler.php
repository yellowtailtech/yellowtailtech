...
use WPFormsConvertKit\Vendor\Monolog\Formatter\LineFormatter;
use WPFormsConvertKit\Vendor\Monolog\Formatter\FormatterInterface;
use WPFormsConvertKit\Vendor\Monolog\Logger;
use WPFormsConvertKit\Vendor\Monolog\Utils;
use WPFormsConvertKit\Vendor\PhpConsole\Connector;
use WPFormsConvertKit\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use WPFormsConvertKit\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('WPFormsConvertKit\\Vendor\\PhpConsole\\Connector')) {
