...
use WPFormsConvertKit\Vendor\Swift_Message;
use WPFormsConvertKit\Vendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\WPFormsConvertKit\Vendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
