...
namespace WPFormsConvertKit\Vendor\Psr\Log\Test;

use WPFormsConvertKit\Vendor\Psr\Log\LoggerInterface;
use WPFormsConvertKit\Vendor\Psr\Log\LogLevel;
use WPFormsConvertKit\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WPFormsConvertKit\\Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WPFormsConvertKit\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WPFormsConvertKit\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
