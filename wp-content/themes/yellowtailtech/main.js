jQuery(document).ready(function() {
		...
		var tiktokSlide = jQuery('.tiktok-items');
        var tiktokSlideLandscape = jQuery('.tiktok-items-landscape');

		tiktokSlide.on('init', function(slick){
		 	var iframe = jQuery('.slick-current iframe');
		...
		tiktokSlide.on('afterChange', function(slick, currentSlide){
		 	var iframe = jQuery('.slick-current iframe');
		 	var player = new Vimeo.Player(iframe);
		 	player.play().then(function() { 
			  player.setVolume(1);
        ...
        tiktokSlideLandscape.on('init', function(slick){
            var iframe = jQuery('.slick-current iframe');
            var player = new Vimeo.Player(iframe);
            player.play().then(function() {
        ...
        tiktokSlideLandscape.on('afterChange', function(slick, currentSlide){
            var iframe = jQuery('.slick-current iframe');
            var player = new Vimeo.Player(iframe);
            player.play().then(function() { 
              player.setVolume(1);
        ...
        jQuery(".slider-rtl3").owlCarousel({
            items: 2,
            loop: !0,
            margin: 20,
            autoplay: !0,
